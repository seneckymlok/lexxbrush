  ...
  return (
    <div className="page-enter min-h-screen flex items-center justify-center px-6 pt-24 pb-24">
      <div className="max-w-md w-full text-center">
        <div className="relative w-16 h-16 mx-auto mb-8 drop-shadow-[0_0_24px_rgba(220,220,30,0.4)]">
          <Image src="/suits/club.webp" alt="" fill className="object-contain" sizes="64px" />
        </div>

        <p className="font-[family-name:var(--font-display)] text-[10px] tracking-[0.4em] uppercase text-white/40 mb-4">
          {t("newsletter.unsubscribed.eyebrow")}
        </p>
