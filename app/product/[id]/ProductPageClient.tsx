          ...
          <div className="mt-10 pt-6 border-t border-white/5">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-3 text-sm text-chrome-light">
                <span className="w-1.5 h-1.5 rounded-full bg-pink" aria-hidden="true" />{t("product.handPainted")}
              </li>
              <li className="flex items-center gap-3 text-sm text-chrome-light">
                <span className="w-1.5 h-1.5 rounded-full bg-cyan" aria-hidden="true" />{t("product.unique")}
              </li>
              <li className="flex items-center gap-3 text-sm text-chrome-light">
                <span className="w-1.5 h-1.5 rounded-full bg-pink-hot" aria-hidden="true" />{t("product.madeInPrague")}
              </li>
            </ul>
          </div>
        </div>
