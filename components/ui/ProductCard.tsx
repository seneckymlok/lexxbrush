          ...
          <div className="absolute top-1 left-1 md:top-2 md:left-2 flex flex-col gap-0.5 z-20">
            {product.isOneOfAKind && (
              <div className="group/badge relative cursor-pointer" onClick={handleDiamondClick}>
                ...
                <span className={`pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-0.5 text-[11px] font-medium tracking-widest uppercase whitespace-nowrap bg-black/80 text-cyan-300 border border-cyan-500/40 rounded transition-opacity duration-200 z-10 ${showDiamondTooltip ? "opacity-100" : "opacity-0 group-hover/badge:opacity-100"}`}>
                  One of one
                </span>
              </div>
            )}
            {product.isSold && (
              <div className="group/badge relative cursor-pointer" onClick={handleSpadeClick}>
                ...
                <span className={`pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-0.5 text-[11px] font-medium tracking-widest uppercase whitespace-nowrap bg-black/80 text-blue-300 border border-blue-500/40 rounded transition-opacity duration-200 z-10 ${showSpadeTooltip ? "opacity-100" : "opacity-0 group-hover/badge:opacity-100"}`}>
                  Sold
                </span>
              </div>
            )}
